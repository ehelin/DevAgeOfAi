...
# Only enable if you trust Microsoft's model repository
TRUST_REMOTE_CODE = True  # Required for Phi-3.5, but review the warning!
...
def main():
    ...
    try:
        ...
        model = AutoModelForCausalLM.from_pretrained(
            ...
            # Additional security: limit model capabilities
